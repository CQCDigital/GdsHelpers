...
namespace GDSHelpers.TagHelpers
{
    ...
    public class DateBoxHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.AddClass("govuk-date-input__item");

            output.PreContent.SetHtmlContent($@"<div class=""govuk-form-group"" id=""{DateBoxId}_item"">");
            ...
            using (var writer = new StringWriter())
            {
                ...
                var textboxBuilder = _htmlGenerator.GenerateTextBox(
                    ...
                    For.Model,
                    null,
                    new { @class = "govuk-input govuk-date-input__input", type = "number", id= DateBoxId
                    });
                ...
                {
                    textboxBuilder.AddCssClass("govuk-input--error");
                }
